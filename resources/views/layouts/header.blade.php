                    ...
                    <ul class="nav-right">
                        <li class="dropdown dropdown-animated scale-left">
                            ...
                            <div class="p-b-15 p-t-20 dropdown-menu pop-profile">
                                <div class="p-h-20 p-b-15 m-b-10 border-bottom">
                                    <div class="d-flex m-r-50">
                                        ...
                                        <div class="m-l-10">
                                            ...
                                            <p class="m-b-0 opacity-07">{{Auth::user()->role->name ?? 'admin'}}</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <a href="javascript:void(0);" class="dropdown-item logout d-block p-h-15 p-v-10">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div>
                                ...
                                <form action="/logout" method="post" id="logoutUser">
                                @csrf
                                </form>
                            </div>
                        </li>
